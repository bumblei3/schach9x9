...
export default defineConfig({
  ...
  /* Parallel tests on CI: 2 workers on 2-CPU runners. Shared state is
     read-only (dist/ served statically, storageState is a seed), retries
     absorb flakiness. */
  ...
  projects: [
    ...
    // Firefox and WebKit are not available on this system
    // {
    //   name: 'firefox',
