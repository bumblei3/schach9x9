    ...
    renderLevels() {
      ...
      `;
            ...
            if (level.unlocked) {
                ...
                btn.onmouseout = () => btn.style.borderColor = level.completed ? 'var(--accent-success)' : 'var(--border-color)';
                btn.onclick = () => {
                    this.hide();
        ...
        ${level.stars ? `<div style="margin-top: auto; color: gold;">${'★'.repeat(level.stars)}</div>` : ''}
      `;
