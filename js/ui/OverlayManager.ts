 ...
 */
export function showModal(title: string, message: string, actions: Array<{ text: string, class?: string, callback?: Function }> = []): void {
 ...
 */
export function showPromotionUI(game: Game, r: number, c: number, color: Player, moveRecord: any, callback?: Function): void {
 ...
 */
export async function showCampaignVictoryModal(title: string, stars: number, actions: any[] = []): Promise<void> {
    const content = `
