 ...
 */
export async function animateMove(game: any, from: Square, to: Square, piece: Piece): Promise<void> {
    ...
    return new Promise(resolve => {
        ...
        setTimeout(() => {
            ...
            if (isCapture) {
                ...
                // Show floating score
                const values: Record<Exclude<PieceType, null>, number> = { p: 1, n: 3, b: 3, r: 5, q: 9, e: 12, a: 7, c: 8, k: 0 };
 ...
 */
export function showMoveQuality(game: any, move: any, category: string): void {
