...
import type { Square, Player } from './types/game.js';
    ...
    constructor() {
        this.puzzles = [
            ...
            },
            {
                ...
                description: 'Weiß zieht und setzt in 1 Zug matt.',
                difficulty: 'Einfach',
                setupStr: '..'.repeat(4) + 'bk' + '..'.repeat(7) + 'bpbpbp' + '..'.repeat(48) + 'wr' + '..'.repeat(3) + 'wk' + '..'.repeat(13) + 'w',
            ...
            },
            {
                ...
                difficulty: 'Mittel',
                setupStr: '..'.repeat(4) + 'bk' + '..'.repeat(13) + 'wr' + '..'.repeat(9) + 'wr' + '..'.repeat(8) + 'wk' + '..'.repeat(81 - 38) + 'w',
                solution: [
