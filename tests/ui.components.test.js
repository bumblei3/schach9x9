...
describe('UI Components Coverage', () => {
    ...
    `;
        ...
        game = {
            ...
            tutorController: {
                getSetupTemplates: jest.fn(() => [{ id: 't1', name: 'T1', pieces: ['p'], description: 'Desc', cost: 10 }]),
    ...
    describe('Board and Status', () => {
        test('exhaustive coverage', () => {
            ...
            BoardRenderer.animateMove(game, { r: 7, c: 4 }, { r: 5, c: 4 }, { type: 'p', color: 'white' });
        ...
        test('TutorUI full details', () => {
            game.getTutorHints = jest.fn(() => [
                { move: { from: { r: 7, c: 4 }, to: { r: 5, c: 4 } }, notation: 'e4', score: 100, analysis: { category: 'excellent', qualityLabel: 'Exzellent', tacticalExplanations: ['Mate'], strategicExplanations: ['Center'], warnings: ['W'], questions: ['Q'] } }
            ]);
