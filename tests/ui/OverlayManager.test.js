...
describe('OverlayManager', () => {
    ...
    `;
        ...
        window.PIECE_SVGS = {
            white: { e: '<svg>we</svg>', q: '<svg>wq</svg>', r: '<svg>wr</svg>', b: '<svg>wb</svg>', n: '<svg>wn</svg>', c: '<svg>wc</svg>', a: '<svg>wa</svg>' },
            black: { e: '<svg>be</svg>', q: '<svg>bq</svg>', r: '<svg>br</svg>', b: '<svg>bb</svg>', n: '<svg>bn</svg>', c: '<svg>bc</svg>', a: '<svg>ba</svg>' }
        };
