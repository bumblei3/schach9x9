...
describe('DOMHandler Comprehensive Coverage', () => {
    ...
    it('initContinueButton should show continue button if autosave exists', () => {
        ...
        domHandler.init();
        expect(document.getElementById('main-menu-continue-btn').classList.contains('hidden')).toBe(false);
    });
    ...
    it('Keyboard Shortcuts: should trigger all keys', () => {
        ...
        const ids = ['toggle-analysis-btn', 'hint-btn', 'best-move-btn', 'threats-btn', 'opportunities-btn'];
