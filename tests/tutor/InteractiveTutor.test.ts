...
describe('Interactive Tutor', () => {
    ...
    it('should show notification if not player turn', async () => {
        ...
        expect(notificationUI.show).toHaveBeenCalledWith('Tipps sind nur verfügbar, wenn du am Zug bist.', 'info');
    });
    ...
    it('should request hint from AIController if it is player turn', async () => {
        ...
        expect(notificationUI.show).toHaveBeenCalledWith('Der Tutor analysiert die Stellung...', 'info');
    ...
    it('should visualize the hint arrow and show explanation', async () => {
        ...
        expect(notificationUI.show).toHaveBeenCalledWith('Tipp: Kontrolliert das Zentrum.', 'success', 'Tutor', 5000);
    });
    ...
    it('should handle case where no hint is found', async () => {
        ...
        expect(notificationUI.show).toHaveBeenCalledWith('Der Tutor konnte keinen klaren Rat finden.', 'info');
    });
});
