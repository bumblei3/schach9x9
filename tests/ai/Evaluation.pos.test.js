...
describe('Positional Evaluation Improvements', () => {
    ...
    test('should penalize Doubled Pawns', () => {
        ...
        const separatedScore = evaluatePosition(board, 'white');
        ...
        board[coordsToIndex(6, 3)] = WHITE_PAWN;
        board[coordsToIndex(6, 6)] = WHITE_PAWN;
        const doubledScore = evaluatePosition(board, 'white');
        ...
        const withDoubled = evaluatePosition(board, 'white');
    ...
    test('should reward Linked Pawns', () => {
        ...
        const linkedScore = evaluatePosition(board, 'white');
