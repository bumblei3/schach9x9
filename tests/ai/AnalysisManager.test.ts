...
describe('AnalysisManager', () => {
    ...
    it('should give better advice for higher accuracy', () => {
        ...
        const goodSummary = { whiteAccuracy: 95, blackAccuracy: 70, mistakes: 0, blunders: 0, keyMoments: [] };
        const badSummary = { whiteAccuracy: 40, blackAccuracy: 70, mistakes: 2, blunders: 1, keyMoments: [] };
