...
import {
    SQUARE_COUNT, PIECE_NONE, WHITE_PAWN, BLACK_PAWN,
    WHITE_ROOK, BLACK_QUEEN,
    coordsToIndex
...
describe('AI Strategy - Move Ordering', () => {
    ...
    test('should prioritize capture moves over quiet moves', () => {
        const fromRow = 4, fromCol = 3;
        const capRow = 3, capCol = 4;
        const quietRow = 3, quietCol = 3;
