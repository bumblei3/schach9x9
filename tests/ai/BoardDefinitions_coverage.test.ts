...
describe('BoardDefinitions Types and Helpers', () => {
    ...
    it('getPieceType extracts type correctly', () => {
        expect(BoardDefinitions.getPieceType(BoardDefinitions.WHITE_ROOK)).toBe(BoardDefinitions.PIECE_ROOK);
        expect(BoardDefinitions.getPieceType(BoardDefinitions.BLACK_KNIGHT)).toBe(BoardDefinitions.PIECE_KNIGHT);
    });

    it('getPieceColor extracts color correctly', () => {
        expect(BoardDefinitions.getPieceColor(BoardDefinitions.WHITE_BISHOP)).toBe(BoardDefinitions.COLOR_WHITE);
        expect(BoardDefinitions.getPieceColor(BoardDefinitions.BLACK_QUEEN)).toBe(BoardDefinitions.COLOR_BLACK);
    });
