...
describe('MoveAnalyzer Unit Tests', () => {
    ...
    test('categorizeMove great move', () => {
        const result = MoveAnalyzer.analyzeMoveWithExplanation({ board, getValidMoves: () => [], isInCheck: () => false }, { from: { r: 7, c: 4 }, to: { r: 5, c: 4 } }, 250, 50, 'white');
    ...
    test('categorizeMove mistake', () => {
        const result = MoveAnalyzer.analyzeMoveWithExplanation({ board, getValidMoves: () => [], isInCheck: () => false }, { from: { r: 7, c: 4 }, to: { r: 5, c: 4 } }, -400, 50, 'white');
    ...
    test('tactical explanations', () => {
        ...
        const result = MoveAnalyzer.analyzeMoveWithExplanation({ board: testBoard, getValidMoves: () => [], isInCheck: () => false }, { from: { r: 7, c: 4 }, to: { r: 5, c: 4 }, captured: { type: 'p', color: 'black' } }, 100, 0, 'white');
