...
import { getAllLegalMoves, makeMove, undoMove, getPseudoLegalMoves } from '../js/ai/MoveGenerator.js';
...
describe('AI Special Moves', () => {
    ...
    test('Should generate kingside castling move for White', () => {
        ...
        const castleMove = moves.find(m => m.from.r === 7 && m.from.c === 4 && m.to.r === 7 && m.to.c === 6);
    ...
    test('Should generate queenside castling move for White', () => {
        ...
        const moves = getAllLegalMoves(game.board, 'white');
        const castleMove = moves.find(m => m.from.r === 7 && m.from.c === 4 && m.to.r === 7 && m.to.c === 2);
    ...
    test('Should generate En Passant move', () => {
        ...
        const epMove = moves.find(m => m.from.r === 3 && m.from.c === 4 && m.to.r === 2 && m.to.c === 3);
