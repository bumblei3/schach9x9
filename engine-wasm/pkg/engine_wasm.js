...
export function get_best_move_wasm(board_bytes, color_str, depth, personality_str, elo) {
    ...
    try {
        ...
        const ptr2 = passStringToWasm0(personality_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.get_best_move_wasm(ptr0, len0, ptr1, len1, depth, ptr2, len2, elo);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
